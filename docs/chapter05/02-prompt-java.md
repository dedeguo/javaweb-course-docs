---
title: Prompt 提示词工程与 Java 模板
---

# 02. 提示词工程与 Java 模板

!!! quote "🎓 本节目标：从“随便聊聊”到“精准控制”"
    你是否发现，AI 有时候很聪明，有时候又答非所问？
    问题的关键不在于 AI 笨，而在于**你的 Prompt (提示词) 写得不够好**。
...
这是 Prompt Engineering 中**性价比最高**的技巧。
不要只告诉 AI “做什么”，而是**给它看几个“成功的例子”**。
...
2. **工具**：使用 Java 15+ 的 **Text Blocks (`"""`)** 和 `.formatted()`，让 Prompt 代码清晰可读。
3. **心法**：**Few-Shot (少样本)** 是提高 AI 准确率的神器，给它几个例子，它就能懂你的规矩。

[下一节：让 AI 说“机器话”：JSON Schema 与解析](03-structured-output.md){ .md-button .md-button--primary }