...
* **[👉 实验 3-1：SpringBoot RESTful API 开发 —— AI 辅助编码实战](lab3-1.md)**
* **任务**：先跟随教师完成 **Student 模块 CRUD**，再独立仿写完成 **Book 模块 CRUD**。
* **目标**：掌握 AI 辅助全流程开发（SQL → 实体类 → Mapper → Service → Controller → 接口测试），理解模式迁移能力。
